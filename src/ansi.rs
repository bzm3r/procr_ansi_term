...
mod test {
    ...
    create_content_eq_tests!(
        ...
        [bold_with_reset: Style::new().reset_before_style().bold(), "hi", "\x1B[0m\x1B[1mhi\x1B[0m"]
        [bold_with_reset_2: Style::new().bold().reset_before_style(), "hi", "\x1B[0m\x1B[1mhi\x1B[0m"]
